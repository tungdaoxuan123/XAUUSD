...
Write-Host "[2/3] Triple-barrier labels" -ForegroundColor Cyan
# ATR scales automatically regardless of symbol value
python train_pipeline\triple_barrier_labels.py --data "$SM" --out "$TB" --pt-atr 1.5 --sl-atr 1.0 --max-hold 30
